...
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// Learnixio AI — 3D Animated Landing Page
...
export default function LandingPage() {
  ...
  const TESTIMONIALS = [
    ...
    { name:"Dev Kothari",    role:"Class 12 · JEE",            text:"Learnixio AI is the only app that actually made me consistent. 30-day streak and counting 🔥", stars:5, color:"#F5A623" },
      ...
      <div style={{ position:"relative", zIndex:1 }}>
        ...
        <div id="features" className="sec">
          <div className="reveal from-left">
            ...
            <p className="sec-desc">From smart notes to AI tutoring — Learnixio AI has every tool modern students need.</p>
          </div>
        ...
        <div id="testimonials" style={{ padding:"80px 0", overflow:"hidden" }}>
          <div className="sec" style={{ paddingBottom:0 }}>
            <div style={{ textAlign:"center" }}>
              ...
              <h2 className="sec-title reveal from-scale delay-1">Students love Learnixio AI</h2>
            </div>
          </div>
        ...
        <div style={{ textAlign:"center", padding:"80px 48px", position:"relative", overflow:"hidden" }}>
          ...
          <p className="sec-desc reveal from-scale delay-2" style={{ margin:"0 auto 44px" }}>
            Join 50,000+ students already using Learnixio AI. Free forever.
          </p>
          <a href="/auth/signup">
        ...
        <footer style={{ borderTop:"1px solid #1A2E4A", padding:"44px 48px", display:"flex", justifyContent:"space-between", alignItems:"center", flexWrap:"wrap", gap:16, maxWidth:1100, margin:"0 auto" }}>
          ...
          <div style={{ fontSize:12, color:"#5A7A9E" }}>© 2026 Learnixio AI · Built with ❤️ for students</div>
