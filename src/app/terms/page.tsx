  ...
  return (
    <main className="min-h-screen bg-[#030711] px-4 py-16 text-slate-200 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-3xl">
        <a href="/" className="text-sm font-bold text-cyan-200 hover:text-white">ZenithStudy</a>
        ...
        <div className="mt-10 space-y-7 text-sm leading-7 text-slate-300">
          <p>By using ZenithStudy, you agree to use the platform for lawful study, productivity, and educational purposes.</p>
          ...
          <p>ZenithStudy may update features, limits, pricing, or these terms as the product evolves.</p>
        </div>
      </div>
    </main>
  );
