    ...
    <main className="min-h-screen bg-[#030711] px-4 py-16 text-slate-200 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-10 space-y-7 text-sm leading-7 text-slate-300">
          <p>By using Learnixio AI, you agree to use the platform for lawful study, productivity, and educational purposes.</p>
          ...
          <p>Learnixio AI may update features, limits, pricing, or these terms as the product evolves.</p>
        </div>
      </div>
    </main>
  );
