    ...
    <main className="min-h-screen bg-[#030711] px-4 py-16 text-slate-200 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-10 space-y-7 text-sm leading-7 text-slate-300">
          <p>ZenithStudy AI uses account, study, and product interaction data to provide notes, planning, AI tutoring, reminders, analytics, and related student productivity features.</p>
          ...
          <p>You can contact us at zenithstudyai@gmail.com for privacy questions or account data requests.</p>
        </div>
      </div>
    </main>
  );
