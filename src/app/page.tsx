...
const faqs = [
  { q: "Is ZenithStudy free?", a: "Yes. You can start with the free plan, then upgrade when you need unlimited AI tools, uploads, and advanced analytics." },
  ...
  { q: "Is my data secure?", a: "ZenithStudy is built with authenticated access and privacy-first product patterns so your study data stays protected." },
    ...
    <main className="min-h-screen overflow-hidden bg-[#030711] text-white selection:bg-cyan-300/30">
      ...
      <nav className="sticky top-0 z-40 border-b border-white/10 bg-[#030711]/65 backdrop-blur-2xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
          <button onClick={() => router.push("/")} className="group flex items-center gap-3" aria-label="ZenithStudy home">
            <img src="/icon-192.png" alt="ZenithStudy Logo" className="h-12 w-12 drop-shadow-[0_0_15px_rgba(56,189,248,0.4)] transition group-hover:scale-105" />
            <span className="text-sm font-extrabold tracking-normal text-white sm:text-xl">ZenithStudy</span>
          </button>
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <SectionHeading
          eyebrow="Why ZenithStudy"
          title="Built for students who want focus, speed, and clarity"
          desc="ZenithStudy combines the intelligence of AI tools with the discipline of a productivity system."
        />
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-0 py-20 sm:px-6 lg:px-8">
        <div className="px-4 sm:px-0">
          <SectionHeading
            ...
            desc="From engineering labs to medical prep and UPSC revision, students use ZenithStudy to stay clear, consistent, and calm."
          />
            ...
            >
              <div className="mb-5 flex items-start justify-between gap-4">
                <div>
                  ...
                  <h3 className="mt-1 text-xl font-black text-white">Help shape ZenithStudy</h3>
                </div>
      ...
      <section id="contact" className="relative z-10 mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          desc="ZenithStudy is built around student workflows, so feedback directly shapes the product."
        />
        <div className="grid gap-5 lg:grid-cols-[0.8fr_1fr]">
          ...
          >
            ...
            <label className="mt-4 grid gap-2 text-sm font-bold text-slate-300">
              Feedback
              <textarea name="message" required rows={5} className="resize-none rounded-xl border border-white/10 bg-slate-950/70 px-4 py-3 text-white outline-none transition focus:border-cyan-200/50" placeholder="Tell us what you want ZenithStudy to improve next." />
            </label>
      ...
      <footer className="relative z-10 border-t border-white/10 bg-[#030711]/80">
        <div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 md:grid-cols-[1fr_auto] lg:px-8">
          <div>
            <div className="flex items-center gap-3">
              <img src="/icon-192.png" alt="ZenithStudy logo" className="h-10 w-10 rounded-xl" />
              <p className="text-base font-black text-white">ZenithStudy</p>
            </div>
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-3 border-t border-white/10 px-4 py-5 text-xs font-semibold text-slate-600 sm:px-6 md:flex-row md:items-center md:justify-between lg:px-8">
          <p>Copyright 2026 ZenithStudy. All rights reserved.</p>
