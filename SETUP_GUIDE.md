...
1. Download કરેલ `zenithstudy-ai.zip` extract કરો
2. Folder name: `zenithstudy-ai`

### 3.2 .env.local File બનાવો

1. `zenithstudy-ai` folder open કરો
...
1. `zenithstudy-ai` folder ની address copy કરો
...
2. **New Repository** → Name: `zenithstudy-ai`
...
4. **"Deploy"** click
5. ⏳ 2 minutes...
6. ✅ Live URL મળશે! (e.g. zenithstudy-ai.vercel.app)
